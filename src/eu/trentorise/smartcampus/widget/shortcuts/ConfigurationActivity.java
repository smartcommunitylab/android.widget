		...
		initSharedPreference();
	     ...
	     // Get the Title
			...
			title = new String[] { "Luoghi", "Eventi",
					"Storie", "Info in tempo reale", "Riassunto", "Conferma" };

			// Generate subtitle
			subtitle = new String[] { "I luoghi di Trento", "I migliori Eventi",
					"Le tue storie da vivere", "Le informazioni aggiornate ogni secondo", "Le tue scelte fino ad ora", "Dai vita al tuo widget" };

			// Generate icon
			icon = new int[] { R.drawable.action_about, R.drawable.action_settings,
					R.drawable.collections_cloud, R.drawable.ic_position, R.drawable.ic_start, R.drawable.ic_alert};
