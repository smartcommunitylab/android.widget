...
import eu.trentorise.smartcampus.widget.shortcuts.ParcheggiListAdapter.ViewHolder;
...
// METODO GETVIEW DOVE VADO A PRENDERE IL PARAMETRI DI BOOKMARKS
    	...
    	if (convertView == null) {
    		...
    		holder.checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
    			...
    			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
    				...
    				checkBoxStateTreni[getPosition] = isChecked;
    				save(checkBoxStateTreni);
    			}
    		});
    		...
    		holder.checkBox.setChecked(checkBoxStateTreni[position]);
	...
	private void save(final boolean[] isChecked) {
		SharedPreferences sharedPreferences = context.getSharedPreferences("sharedPrefsTreni", Context.MODE_PRIVATE);
