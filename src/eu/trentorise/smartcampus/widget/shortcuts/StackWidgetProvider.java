...
public class StackWidgetProvider extends AppWidgetProvider {
	public static final String INTENT_ACTION = "com.example.android.stackwidget.INTENT";
	public static final String EXTRA_INTENT = "com.example.android.stackwidget.EXTRA_ITEM";
...
//			rv.setEmptyView(R.id.stack_view, R.id.empty_view);
			...
			toastIntent.setAction(StackWidgetProvider.INTENT_ACTION);
