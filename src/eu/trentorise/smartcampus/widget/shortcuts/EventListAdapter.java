...
public class EventListAdapter extends ArrayAdapter {
    ...
    public boolean[] checkBoxStateEvent;
    FragResume resume = new FragResume();
    ViewHolder holder;
    //bundle to resume
    Bundle bundle = new Bundle();
    
    public EventListAdapter ( Context ctx, int resourceId, List<BookmarkDescriptor> objects, boolean[] check) {
...
// METODO GETVIEW DOVE VADO A PRENDERE IL PARAMETRI DI BOOKMARKS
    	...
    	if (convertView == null) {
    		...
    		holder.checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
    			...
    			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
    				...
    				checkBoxStateEvent[getPosition] = isChecked;
    				save(checkBoxStateEvent);
    			}
    		});
    		...
    		holder.checkBox.setChecked(checkBoxStateEvent[position]);
	...
	private void save(final boolean[] isChecked) {
		SharedPreferences sharedPreferences = context.getSharedPreferences("sharedPrefsEvents", Context.MODE_PRIVATE);
