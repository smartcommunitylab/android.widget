...
public class FragStories extends SherlockFragment{
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		for (BookmarkDescriptor bookmarkDescriptor : bookmark) {
			if(bookmarkDescriptor.getIntent()==getResources().getString(R.string.stories_intent_action)){
		...
		listViewObject = (ListView) getSherlockActivity().findViewById(
				R.id.fragstories);
		listViewObject.setAdapter(new StoriesListAdapter(getSherlockActivity(),
